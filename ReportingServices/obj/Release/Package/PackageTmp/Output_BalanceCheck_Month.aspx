<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Output_BalanceCheck_Month.aspx.cs" Inherits="ReportingServices.Output_BalanceCheck_Month" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="1209px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1270px" ProcessingMode="Remote">
            <ServerReport ReportPath="/output_balancecheck_month"/>
        </rsweb:ReportViewer>
    </div>
