    ...
    <script type="text/javascript">
        function refreshclick() {
            if ($("#autorefresh")[0].checked) {
                var l = setInterval('$("#refresh_Jqgrid1_top").click()', 300000);
...
<%--                <asp:ListItem Text="1号机组" Value="1"></asp:ListItem>
            ...
            <input id="autorefresh" type="checkbox" onchange="refreshclick()" />
            <asp:Button ID="btn_validate" runat="server" Text="批量确认" OnClick="btn_validate_Click" class="easyui-linkbutton" width="80" Height="25" Visible="false"/>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
